...
public class DBConfig extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // sample data
        String querySampleData = "INSERT INTO notes (title, description) VALUES ('catatan awal', 'Selamat mencatat kawan'), ('makin tua makin absurd', 'Minta tolong diringanin sih tuhan'), ('Target Tahun Ini', 'Lulus geh biar cepet kerja')";
